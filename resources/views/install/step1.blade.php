...
<div class="row justify-content-center ins-two">
  	<div class="col-md-6">
    	<div class="card card_entry">
      		<div class="card-body">
        		<div class="panel panel-default ins-three" data-collapsed="0">
    				<!-- panel body -->
    				<div class="panel-body ins-four ins">
			            <p class="ins-four">
			            ...
			            <?php if ($valid == true) { ?>
			              <p>
			                <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
			                  <a href="{{ route('step3') }}" class="btn btn-primary btn_01">
			                    {{ __('Continue') }}
			                  </a>
			                <?php } else { ?>
			                  <a href="{{ route('step2') }}" class="btn btn-primary btn_01">
			                    {{ __('Continue') }}
			                  </a>
			                <?php } ?>
			              </p>
			            ...
			            <?php if ($valid != true) { ?>
			              <p>
			                <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1') { ?>
			                  <a href="{{ route('step3') }}" class="btn btn-primary btn_01" disabled>
			                    {{ __('Continue') }}
			                  </a>
			                <?php } else { ?>
			                  <a href="{{ route('step2') }}" class="btn btn-primary btn_01" disabled>
			                    {{ __('Continue') }}
			                  </a>
			                <?php } ?>
			                <a href="{{ route('step1') }}" class="btn btn-primary btn_01" >
